...
\begin{document}
    ...
    \section{Vecteurs}
        ...
        \subsection{Sous-espaces vectoriels}  % Sous-espaces
            ...
            Autrement dit, $\forall v \in E, \exists $ une c.l. (finies) de vecteurs de A tels que $v = \displaystyle \sum_{i=1}^n \lambda_i v_i , v_1; \cdots ; v_n \in$ A
            \end{mdframed}
            ...
            C'est à dire si $\displaystyle \sum_{i=1}^n \lambda_i v_i = \overrightarrow{0_E}, v_1; ... ; v_n \in a\Rightarrow \lambda_1 = 0;...; \lambda_n = 0$\\
            ...
            \item E = $\R^3$, \texttt{A'} = \{ (1;1;3) ; (5;2;-1) ; (4;1;-4) \}\\
            ...
            \item E = $\R^3$, \texttt{A''} = \{ (1;1;3) ; (5;2;-1) \}\\
            ...
            \begin{itemize}
             ...
             \item a est libre, $v \in$ vect(a), alors il existe une unique c.l.de vecteurs de a égale à $v$.
                      Autrement dit: $\exists (v_1;...;v_n) \in a, v = \displaystyle \sum_{i=1}^n \lambda_i v_i$
            ...
            \begin{itemize}
             \item dim($\R^n$) = $n$
             \item dim($\R^\mathbb N$) = $\infty$ (car $\mathbb N$ à une infinité d'éléments)
